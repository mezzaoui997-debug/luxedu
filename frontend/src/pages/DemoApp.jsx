...
export default function DemoApp() {
  ...
  const spaces = [
    ...
    },
    {
      ...
      subtitle: "iPhone et Android — notes, absences, paiements en temps reel",
      desc: "Voyez ce que voient les parents sur leur telephone : notes de leur enfant, absences signalees instantanement, paiements avec RIB, reclamations et orientation BAC.",
      features: ["Notes et moyennes en direct", "Alertes absences instantanees", "Paiements et historique", "Reclamations en ligne", "Orientation BAC IA", "Messagerie avec l ecole"],
      ...
      action: () => navigate("/mobile"), role: "MOBILE_PARENT", cta: "Voir l application mobile parents",
    },
    {
      id: "mobile_student",
      tag: "APPLICATION MOBILE",
      title: "Portail Etudiant",
      subtitle: "iPhone et Android — espace personnel de l eleve",
      desc: "Explorez l espace de l etudiant sur mobile : bulletin de notes interactif, devoirs et echeances, orientation universitaire par IA et messagerie avec les professeurs.",
      features: ["Bulletin de notes numerique", "Devoirs et echeances", "Orientation IA Tawjih BAC", "Messagerie professeurs", "Emploi du temps", "Acces par code Massar"],
      color: "#EA580C", border: "#FED7AA", tagBg: "rgba(234,88,12,.1)", tagC: "#EA580C",
      icon: <><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></>,
      action: () => navigate("/etudiant"), role: "MOBILE_STUDENT", cta: "Voir l application mobile etudiants",
    },
  ];
